...
const SettingsPanel = ({
  ...
  return (
    <div className="relative">
      <div
        className={`fixed top-0 left-0 h-full w-[40%] z-30 md:w-[20%] p-1 bg-customBg text-white shadow-lg transition-transform duration-300 border-r-[1px] border-gray-600 ${
